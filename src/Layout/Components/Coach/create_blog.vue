    ...
    <b-row>
          ...
          <b-card class="main-card">
                  <form class="">
                                <div class="form-row">
                                <div class="col-md-6">
                                    <div class="position-relative form-group"><label for="firstname" class="">Image</label><input name="image" id="image"  type="file" class="form-control"></div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group"><label for="lastname" class="">Title</label><input name="title" id="title" placeholder="Title" type="text" class="form-control"></div>
                                    </div>                         
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                         <v-textarea outline  name="input-7-4"  label="Content"></v-textarea>
                                    </div>                         
                                </div>
                               ...
                               <button class="btn-shadow btn-md btn btn-dark ">
                                    <font-awesome-icon icon="save" /> Save
                                </button>
                            </div>
                            </form>
            <div class="card-footer-tab card-footer"></div>
          </b-card>
        </b-col>
